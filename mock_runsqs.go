...
// Source: /Users/dduncan/go/pkg/mod/github.com/asecurityteam/runsqs/v4@v4.0.0/interface.go
//
// Generated by this command:
//
//	mockgen -source=/Users/dduncan/go/pkg/mod/github.com/asecurityteam/runsqs/v4@v4.0.0/interface.go -destination=mock_runsqs.go -package=stat
//
...
import (
	...
	v4 "github.com/asecurityteam/runsqs/v4"
...
func (m *MockSQSConsumer) GetSQSMessageConsumer() v4.SQSMessageConsumer {
	...
	ret0, _ := ret[0].(v4.SQSMessageConsumer)
	return ret0
}
...
func (m *MockSQSMessageConsumer) ConsumeMessage(ctx context.Context, message *types.Message) v4.SQSMessageConsumerError {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ConsumeMessage", ctx, message)
	ret0, _ := ret[0].(v4.SQSMessageConsumerError)
	return ret0
}
